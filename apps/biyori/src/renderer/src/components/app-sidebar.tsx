...
const primaryItems = [
	{ to: "/app/now-playing", label: "Now Playing", icon: PlayIcon },
] as const;
	...
	return (
		<Link
			...
			className={cn(
				...
				active
					? "border border-accent-foreground/15 bg-accent text-accent-foreground"
					: "border border-transparent text-foreground/80 hover:bg-muted",
			)}
		>
