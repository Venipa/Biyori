		...
		<Tabs defaultValue='discord'>
			...
			<TabsContent value='discord' className='pt-4'>
				<FieldGroup>
					...
					<FieldDescription>Note: Requires using the Discord desktop client.</FieldDescription>
				</FieldGroup>
			</TabsContent>
			<TabsContent value='http' className='pt-4'>
				<FieldGroup>
					...
					<FieldDescription>GET http://127.0.0.1:PORT returns now-playing JSON.</FieldDescription>
				</FieldGroup>
			</TabsContent>
		</Tabs>
	);
