		...
		<Tabs defaultValue='anilist'>
			...
			<TabsContent value='main' className='pt-4'>
				<FieldSet className='rounded-md border p-3'>
					...
					<p className='text-sm text-muted-foreground'>Choose which service your list, updates, and synchronization use by default.</p>
					<Controller
			...
			<TabsContent value='myanimelist' className='pt-4'>
				<p className='text-sm text-muted-foreground'>Connect your MyAnimeList account to sync your list.</p>
			</TabsContent>
			<TabsContent value='kitsu' className='pt-4'>
				<p className='text-sm text-muted-foreground'>Connect your Kitsu account to sync your list.</p>
			</TabsContent>
						...
						{connected ? (
							<Field>
								...
								<div className='flex items-center gap-2'>
									<Input id={usernameId} value={username} readOnly className='flex-1 pointer-events-none select-none' />
									<Button
										type='button'
										variant='outline'
										className='shrink-0'
