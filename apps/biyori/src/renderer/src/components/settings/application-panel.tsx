...
const listStatusItems = Object.fromEntries(listStatusSchema.options.map((status) => [status, status])) as Record<(typeof listStatusSchema.options)[number], string>;
				...
				<FieldGroup>
						...
						<Controller
							...
							render={({ field, fieldState }) => (
								<Field data-invalid={fieldState.invalid || undefined}>
									<FieldLabel htmlFor={titleLanguageId}>Title language preference:</FieldLabel>
					...
					<FieldSet className='rounded-md border p-3'>
						...
						<Controller
							...
							render={({ field, fieldState }) => (
								<Field data-invalid={fieldState.invalid || undefined}>
									<FieldLabel htmlFor={defaultAddToListStatusId}>Default status when adding:</FieldLabel>
									<div className='max-w-64'>
										<Select
											...
											<SelectTrigger id={defaultAddToListStatusId} className='w-full'>
												<SelectValue />
											</SelectTrigger>
											<SelectContent>
												<SelectGroup>
