...
export function isService(value: unknown): value is Service {
	return typeof value === "object" && value !== null && kService in value && (value as { [kService]: unknown })[kService] === true;
}
...
export function serviceHook(service: Service, phase: LifecyclePhase): LifecycleFn | null {
