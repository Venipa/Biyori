...
import { getRepositoryUrl, type LatestRelease, RELEASE_CHANNELS, type ReleaseChannel, resolveReleaseChannel } from "./downloads";
...
const nextFetch = ((input: RequestInfo | URL, init?: RequestInit) =>
	fetch(input, {
		...init,
...
export async function listReleases(options?: { maxPages?: number; includePrereleases?: boolean }): Promise<LatestRelease[]> {
